  ...
  bootcamps = [
    {
      ...
      introText: '</SALT> specialises in training the next generation of software developers. Tech stack:',
    ...
    },
    {
      ...
      location: 'Amsterdam, Netherlands',
      introText: '10-week full-time intensive coding bootcamp learning. Tech Stack:',
