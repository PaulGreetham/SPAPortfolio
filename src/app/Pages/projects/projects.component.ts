  ...
  protected cards: ProjectCard[] = [
    {
      ...
      description: 'A React application that uses the OpenAI API to generate detailed 500-word essays about football players, in the style of Ernest Hemingway.',
      techStack: [
        { logoUrl: 'assets/logos/Openai.png', websiteUrl: 'https://openai.com/' },
        { logoUrl: 'assets/logos/React.png', websiteUrl: 'https://angular.dev/' },
      ...
      websiteUrl: 'https://the-beautiful-game.netlify.app/',
      githubUrl: 'https://github.com/PaulGreetham/the-beautiful-game'
    },
    {
      id: 'card-2',
