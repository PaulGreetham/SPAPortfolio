...
export class ProjectsComponent {
  protected cards = [
    ...
    { id: 'card-5', title: 'Project 5', description: 'Description 5', animationClass: 'animate-delay-5' },
    { id: 'card-6', title: 'Project 6', description: 'Description 6', animationClass: 'animate-delay-6' },
  ];
}
